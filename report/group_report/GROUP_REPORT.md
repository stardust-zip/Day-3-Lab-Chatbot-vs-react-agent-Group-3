...
> **Bài học lớn nhất**: Chatbot chỉ biết nói, Agent biết HÀNH ĐỘNG. Nhưng Agent chỉ mạnh khi có:
>- (1) tool description rõ ràng
>- (2) few-shot examples tốt
>- (3) đủ steps để hoàn thành nhiệm vụ.
